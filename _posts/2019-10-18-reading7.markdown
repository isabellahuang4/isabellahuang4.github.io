---
layout: post
title:  "Reading Assignment 7: Usability"
date:   2019-10-04 12:52:48 -0600
categories: posts
---

My everyday task will be making coffee (because a mathematician's job
is turning coffee into theorems).
I do this every morning as a coffee nerd does: 

first: weighing out the beans (requires a scale)

second: grinding the beans

third: heating the water (requires a kettle)

fourth: mixing grounds with water (I'll skip the intricacies of this "step")

In weighing out the beans, the gulf of execution is small.
...
I have to wait for at least 2 seconds to determine whether I have "done the thing". 

For these issues with the scale, I would refer to the heuristic of "visibility
of system status". 
